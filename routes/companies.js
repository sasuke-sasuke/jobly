...
const { ensureLoggedIn, admin } = require("../middleware/auth");
...
router.get("/", async function (req, res, next) {
  ...
  if (minEmployees !== undefined) minEmployees = +minEmployees;
  if (maxEmployees!== undefined) maxEmployees = +maxEmployees;
